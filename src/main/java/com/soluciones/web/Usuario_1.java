...
public class Usuario_1 implements Serializable {
    ...
    public Usuario_1(String usuario) {
        this.usuario = usuario;
    }

    public Usuario_1(String usuario, String nombre, String paterno, String email, String password, Character adminRol) {
        this.usuario = usuario;
        this.nombre = nombre;
    ...
    public String toString() {
        return "com.soluciones.web.Usuario[ usuario=" + usuario + " ]";
    }
